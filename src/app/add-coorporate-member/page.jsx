            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-12/12 px-4">
                <TextField
                  ...
                  variant="outlined"
                />
                <FormHelperText id="house-number" className={'text-red-800'}>
                  Weight
                </FormHelperText>
              </div>
              ...
              <div className="w-full lg:w-4/12 px-4">
                <TextField
                  ...
                  variant="outlined"
                />
                <FormHelperText id="phone-number" className={'text-red-800'}>
                  Weight
                </FormHelperText>
              </div>
              <div className="w-full lg:w-12/12 px-4">
            ...
            <div className="flex flex-wrap">
              <div className="w-full lg:w-12/12 px-4">
                <TextField
                  ...
                  variant="outlined"
                />
                <FormHelperText id="education-level" className={'text-red-800'}>
                  Weight
                </FormHelperText>
              </div>
              <div className="w-full lg:w-4/12 px-4">
                <TextField
                  ...
                  variant="outlined"
                />
                <FormHelperText id="main-occupation" className={'text-red-800'}>
                  Weight
                </FormHelperText>
              </div>
              <div className="w-full lg:w-4/12 px-4">
              ...
              <div className="w-full lg:w-4/12 px-4">
                <TextField
                  ...
                  variant="outlined"
                />
                <FormHelperText id="crops-produced" className={'text-red-800'}>
                  Weight
                </FormHelperText>
              </div>
              <div className="w-full lg:w-4/12 px-4">
                <TextField
                  ...
                  variant="outlined"
                />
                <FormHelperText id="own-farm-size" className={'text-red-800'}>
                  Weight
                </FormHelperText>
              </div>
            </div>
